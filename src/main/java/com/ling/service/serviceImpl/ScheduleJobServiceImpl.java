...
import com.ling.dao.mapper.ScheduleJobDao;
...
public class ScheduleJobServiceImpl implements ScheduleJobService {
	...
	@PostConstruct
	public void init(){
		List<ScheduleJob> scheduleJobList = schedulerJobDao.selectAll();
	...
	public List<ScheduleJob> queryList(Map<String, Object> map) {
		return schedulerJobDao.selectByExample(map);
	}

	@Override
	public int queryTotal(Map<String, Object> map) {
		return schedulerJobDao.selectCountByExample(map);
	}
